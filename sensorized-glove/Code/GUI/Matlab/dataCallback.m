function dataCallback(obj, event, app)
    ...
    %Adjusted Data
    app.cap1AdjData = [ app.cap1AdjData str2num(sData(indIndexes(2)+1 : indIndexes(3)-1)) - app.capRef(1) ];
    app.cap2AdjData = [ app.cap2AdjData str2num(sData(indIndexes(3)+1 : indIndexes(4)-1)) - app.capRef(2) ];
    app.cap3AdjData = [ app.cap3AdjData str2num(sData(indIndexes(4)+1 : indIndexes(5)-1)) - app.capRef(3) ];
    app.cap4AdjData = [ app.cap4AdjData str2num(sData(indIndexes(5)+1 : indIndexes(6)-1)) - app.capRef(4) ];
    app.cap5AdjData = [ app.cap5AdjData str2num(sData(indIndexes(6)+1 : indIndexes(7)-1)) - app.capRef(5) ];
    app.cap6AdjData = [ app.cap6AdjData str2num(sData(indIndexes(7)+1 : indIndexes(8)-1)) - app.capRef(6) ];
    app.cap7AdjData = [ app.cap7AdjData str2num(sData(indIndexes(8)+1 : indIndexes(9)-1)) - app.capRef(7) ];
    app.cap8AdjData = [ app.cap8AdjData str2num(sData(indIndexes(9)+1 : indIndexes(10)-1)) - app.capRef(8) ];
    app.cap9AdjData = [ app.cap9AdjData str2num(sData(indIndexes(10)+1 : indIndexes(11)-1)) - app.capRef(9) ];
    app.cap10AdjData = [ app.cap10AdjData str2num(sData(indIndexes(11)+1 : indIndexes(12)-1)) - app.capRef(10) ];
    app.cap11AdjData = [ app.cap11AdjData str2num(sData(indIndexes(12)+1 : indIndexes(13)-1)) - app.capRef(11) ];
    app.cap12AdjData = [ app.cap12AdjData str2num(sData(indIndexes(13)+1 : indIndexes(14)-1)) - app.capRef(12) ];
    app.cap13AdjData = [ app.cap13AdjData str2num(sData(indIndexes(14)+1 : indIndexes(15)-1)) - app.capRef(13) ];
    app.cap14AdjData = [ app.cap14AdjData str2num(sData(indIndexes(15)+1 : indIndexes(16)-1)) - app.capRef(14) ];
    app.cap15AdjData = [ app.cap15AdjData str2num(sData(indIndexes(16)+1 : indIndexes(17)-1)) - app.capRef(15) ];
    app.cap16AdjData = [ app.cap16AdjData str2num(sData(indIndexes(17)+1 : indIndexes(18)-1)) - app.capRef(16) ];
