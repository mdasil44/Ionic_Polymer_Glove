function plotData(obj, event, app)
    ...
    if app.timeData(end) < app.plotLength
        ...
        plot(app.CapacitanceAxes,   app.timeData(startTime:end), app.cap15AdjData(startTime:end), ...
                                    app.timeData(startTime:end), app.cap2AdjData(startTime:end), ...
                                    app.timeData(startTime:end), app.cap3AdjData(startTime:end), ...
                                    app.timeData(startTime:end), app.cap4AdjData(startTime:end), ...
                                    app.timeData(startTime:end), app.cap5AdjData(startTime:end), ...
                                    app.timeData(startTime:end), app.cap6AdjData(startTime:end), ...
                                    app.timeData(startTime:end), app.cap7AdjData(startTime:end), ...
                                    app.timeData(startTime:end), app.cap8AdjData(startTime:end), ...
                                    app.timeData(startTime:end), app.cap9AdjData(startTime:end), ...
                                    app.timeData(startTime:end), app.cap10AdjData(startTime:end), ...
                                    app.timeData(startTime:end), app.cap11AdjData(startTime:end), ...
                                    app.timeData(startTime:end), app.cap12AdjData(startTime:end), ...
                                    app.timeData(startTime:end), app.cap13AdjData(startTime:end), ...
                                    app.timeData(startTime:end), app.cap14AdjData(startTime:end), ...
                                    app.timeData(startTime:end), app.cap15AdjData(startTime:end), ...
                                    app.timeData(startTime:end), app.cap16AdjData(startTime:end));
                                
        app.CapacitanceAxes.XLim = [app.timeData(startTime) app.timeData(end)];
        
        plottedData = [ app.cap1AdjData(startTime:end)  app.cap2AdjData(startTime:end)  app.cap3AdjData(startTime:end)  app.cap4AdjData(startTime:end) ...
                        app.cap5AdjData(startTime:end)  app.cap6AdjData(startTime:end)  app.cap7AdjData(startTime:end)  app.cap8AdjData(startTime:end) ...
                        app.cap9AdjData(startTime:end)  app.cap10AdjData(startTime:end) app.cap11AdjData(startTime:end) app.cap12AdjData(startTime:end) ...
                        app.cap13AdjData(startTime:end) app.cap14AdjData(startTime:end) app.cap15AdjData(startTime:end) app.cap16AdjData(startTime:end) ];
