...
int const ReadDuration = 100000;             // in milliseconds
...
int main(int argc, char *argv[])
{
    ...
    for (int i = 0, n = ReadDuration / ReadInterval; i < n; ++i)
    {
        ...
        //get the amount of frames ready
        ...
        if(!saveToFile(out, data, times, nFramesReady, FrameSize, 0 == i))
        {
            wcout << "Saving data to a file failed. Closing program..." << endl;;
            exitProgram();
        }
    }
